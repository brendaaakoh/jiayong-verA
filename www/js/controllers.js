...
.controller('MyTasksCtrl', function($filter, $scope,$window, $http, $state, $ionicPopup, $ionicLoading) {
  var config = { cache: false };
  $scope.activeTab = 1;
...
.controller('ViewCompletedPendingApprovalTaskDetailCtrl', function($filter, TasksCrud, $ionicPopup, $scope, $stateParams, $ionicLoading, $window, $http, $filter, $rootScope, $state) {
   var config = { cache: false };
    // get individual task according to ID
    $scope.taskId = $stateParams.id;
...
.controller('PendingTasksCtrl', function($filter, $scope, $window, $state, $http, $ionicPopup, $ionicLoading ) {
...
.controller('ViewPendingApprovalTaskDetailCtrl', function($filter, TasksCrud, $scope, $stateParams, $window, $ionicLoading, $http, $filter, $rootScope, $state) {
   var config = { cache: false };
    // get individual task according to ID
    $scope.taskId = $stateParams.id;
    $scope.currentUser = JSON.parse($window.localStorage.getItem("currentUser"));
