...
.controller('ProposeTaskCtrl', function($filter, $scope, $state, $ionicPopup, $window, $http,$ionicLoading, $rootScope) {
...
.controller('MyProposedTasksCtrl', function($filter, $scope, $ionicPopup, $http, $stateParams,$ionicLoading, $window, $state) {
  var config = { cache: false };
  $scope.activeTab = 1;
    ...
    var alertPopupTask1 = $ionicPopup.alert({
       ...
       buttons: [
        { text: 'Cancel' },
        {
          ...
          onTap: function(e) {
            $scope.showForm();
            window.open('https://brenksw.typeform.com/to/OK1jzu');
          } 
